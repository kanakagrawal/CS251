...
namespace cs251
{
  ...
  class b2MagnetDef : public b2BodyDef{
  	...
  	b2MagnetDef(){
  		...
  		*(int*)(userData) = 1;			//1 implies attractive magnet
  	}
  ...
  dominos_t::dominos_t()
  {
    ...
    //Creating ground and other boundaries so that ball doenot escape
    {
      ...
      b2DefaultBodyDef bd1(0.0f,-5.0f),bd2(0.0f,43.0f),bd3(-50.0f,20.0f),bd4(50.0f,20.0f);
    ...
    // Creating  magnet balls
    {
      ...
      f.shape = &shape;
      f.friction = 0.0f;
      b2MagnetDef bd1(-25.0f,20.0f),bd2(25.0f,20.0f);
      b1 = m_world->CreateBody(&bd1);
      b1->CreateFixture(&f);
      b2 = m_world->CreateBody(&bd2);
      b2->CreateFixture(&f);
